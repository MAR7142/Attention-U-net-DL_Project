...
def weights_init_kaiming(m):
    ...
    #print(classname)
    if classname.find('Conv') != -1:
        # torch.nn.init removed the non-underscore in-place initializers; use kaiming_normal_
        init.kaiming_normal_(m.weight.data, a=0, mode='fan_in')
    elif classname.find('Linear') != -1:
        # torch.nn.init removed the non-underscore in-place initializers; use kaiming_normal_
        init.kaiming_normal_(m.weight.data, a=0, mode='fan_in')
    elif classname.find('BatchNorm') != -1:
        # torch.nn.init removed the non-underscore in-place initializers; use normal_/constant_
