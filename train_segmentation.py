...
def train(arguments):
    ...
    # num_workers=16 OOM-kills on memory-constrained environments (e.g. Colab); 2 is the
    # lighter setting Colab suggests while still using worker subprocesses for loading.
